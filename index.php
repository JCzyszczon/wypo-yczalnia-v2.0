...
<head>
    ...
    <title>NETFLEX - wypożyczalnia filmów i seriali</title>
...
<body>
    <header>
        ...
        <ul class="navbar">
            ...
            <li><a href="login.php">Filmy</a></li>
            <li><a href="login.php">Seriale</a></li>
            <li><a href="login.php">Polecane</a></li>
        ...
        <a href="login.php" class="btn1">Logowanie</a>
        <a href="rejestracja.php" class="btn2">Rejestracja</a>
    </header>
